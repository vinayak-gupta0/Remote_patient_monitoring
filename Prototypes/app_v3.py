'''
Archive for iteration 3 where cloud database Tsuru was attempted to be connected.
Low refreshing rate and latency was encountered which needed further optimizations.
'''
import random
