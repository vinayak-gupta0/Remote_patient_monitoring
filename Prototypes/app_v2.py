"""Archived prototype with iteration 2 
   where local database, alerting system and scoring were integrated.
   All functions are kept at the same place for the convinience at the development but will be split out later.
